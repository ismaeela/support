...
include_once("config/con2.php");
 ...
 if(isset($_GET['id'])){
  $id = $_GET['id'];
                          //  $sqla = "SELECT * from booking where id =$id";
                          //  $answer = $con2 ->query($sqla);
                          //  $isah= mysqli_fetch_array($answer);
...
<head>
  ...
  <title>Al Hayamu car parking</title>
      ...
      <section class="wrapper">
        <div class="row">
          ...
          <div class="tab-content">
              ...
              <h4 class="text-center">Reciept</h4>
              <hr>         
              ...
              <hr>         
                ...
                <tbody> -->
                 ...
                 <?php foreach($result3 as $row2):?>  -->
                  <tbody>
                  <?php   while($rows = $result->fetch_array()){?>
						      <tr>
						        <td><b>Full Name</b></td>
