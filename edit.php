 ...
 if(isset($_POST['update'])){
   if(isset($_GET['id'])){
    ...
    // $parking = mt_rand(10000,99999);
      ...
      $charge = $_POST['charge'];
      $sql1="UPDATE booking SET parking_id=$parking,fname=$fname,lname=$lname,oname=$oname,phone=$phone,email=$email,
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="pid"><b>Parking_id</b></label>
                                <input type="text" name="pid" id="pid" class="form-control" value="<?php echo $parking;?>">
                            </div>
                          </div> 
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="oname"><b>Other Name</b></label>
                              <input type="text" name="oname" id="oname" class="form-control" value="<?php echo $oname;?>">
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="car"><b>Car Model</b></label>
                              <input type="text" name="car" id="car" class="form-control" value="<?php echo $car;?>">
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="pnumber"><b>Plate Number</b></label>
                              <input type="text" name="pnumber" id="pnumber" class="form-control" value="<?php echo $pnumber;?>">
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="time_in"><b>Time in</b></label>
                              <input type="time" name="timein" id="time_in" class="form-control" value="<?php echo $time_in;?>">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="time_out"><b>Time Out</b></label>
                              <input type="time" name="timeout" id="time_out" class="form-control" value="<?php echo $time_out;?>">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="charge"><b>Charge</b></label>
                              <input type="currency" name="charge" id="charge" class="form-control" value="<?php echo $charge;?>">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <input type="submit" value="Update" class="btn btn-primary btn-center mx-auto" name="update">
                          </div>
                        </div>
